 ...
 */
public class FindbugsSecurityAuditScalaProfile extends ProfileDefinition {

    private static final String FINDBUGS_SECURITY_AUDIT_PROFILE_NAME = "FindBugs Security Audit (Scala)";
    private final FindbugsScalaProfileImporter importer;

    public FindbugsSecurityAuditScalaProfile(FindbugsScalaProfileImporter importer) {
