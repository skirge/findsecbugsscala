...
public final class FindbugsScalaRulesDefinition implements RulesDefinition {

    public static final String REPOSITORY_KEY = "findbugs-scala";
    public static final String REPOSITORY_NAME = "FindBugs (Scala)";
    ...
    public void define(Context context) {
        ...
        ruleLoaderJsp.load(repository, FindbugsScalaRulesDefinition.class.getResourceAsStream("/org/sonar/plugins/findbugs/rules-findbugs.xml"), "UTF-8");
